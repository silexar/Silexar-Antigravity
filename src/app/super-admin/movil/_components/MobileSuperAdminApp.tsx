  ...
  return (
    <div className="pb-24 pt-6 px-4 space-y-6">
      <div>
        ...
        <p className="text-slate-400 mt-1">Super Admin Silexar Pulse</p>
      </div>
      ...
      <div className="bg-slate-800/60 rounded-3xl p-5 border border-slate-700/50">
        ...
        <div className="space-y-4">
          <div className="flex gap-3 items-start">
            ...
            <div>
              <p className="text-sm text-slate-200">24 intentos de login anómalos bloqueados.</p>
          ...
          <div className="flex gap-3 items-start">
            ...
            <div>
              <p className="text-sm text-slate-400">Rotación de llaves API completada para [Tier: Enterprise].</p>
...
function PlaceholderTab({ title, icon: Icon, color }: { title: string; icon: React.ElementType; color: string }) {
  return (
    <div className="flex flex-col items-center justify-center h-[70vh] px-6 text-center">
      ...
      <p className="text-slate-400">Esta sección del panel de control está siendo optimizada para la experiencia móvil TIER 0.</p>
    </div>
  );
}
...
export function MobileSuperAdminApp() {
  ...
  return (
    <div className="min-h-[100dvh] bg-slate-900 text-slate-50 flex flex-col font-sans">
      
      {/* Top Navbar */}
      <nav className="sticky top-0 z-40 bg-slate-900/80 backdrop-blur-xl border-b border-slate-800/50 px-4 py-3 pb-safe-top">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
             ...
             <div>
               <h1 className="text-white font-bold leading-none">Silexar</h1>
               <span className="text-[10px] font-bold text-red-400 tracking-widest uppercase">Super Admin</span>
             </div>
          </div>
          <button className="w-10 h-10 flex items-center justify-center rounded-xl bg-slate-800 text-slate-400">
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 pt-safe-bottom">
        <div className="bg-slate-900/90 backdrop-blur-2xl border-t border-slate-800 px-2 py-2 shadow-[0_-10px_40px_rgba(0,0,0,0.5)]">
              ...
              return (
                ...
                >
                  <div className={`transition-all duration-300 flex flex-col items-center ${
                    isActive ? 'text-red-400 -translate-y-1' : 'text-slate-500'
                  }`}>
