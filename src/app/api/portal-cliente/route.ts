/**
 * 🌐 SILEXAR PULSE - API Portal Cliente
 * 
 * @version 2025.1.0
 */
...
export async function GET(request: NextRequest) {
  try {
    ...
    logger.error('[API/PortalCliente] Error GET:', error instanceof Error ? error : undefined, { module: 'portal-cliente', action: 'GET' });
...
export async function POST(request: NextRequest) {
  try {
    ...
    logger.error('[API/PortalCliente] Error POST:', error instanceof Error ? error : undefined, { module: 'portal-cliente', action: 'POST' });
    return apiServerError()
  }
}
