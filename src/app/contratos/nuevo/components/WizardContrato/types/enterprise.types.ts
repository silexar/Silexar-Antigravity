...
export type EstadoClausula = 'borrador' | 'revision' | 'aprobada' | 'obsoleta' | 'archivada';
...
export interface VariableClausula {
  nombre: string;
  tipo: 'texto' | 'numero' | 'fecha' | 'moneda' | 'porcentaje' | 'select' | 'calculado';
  requerida: boolean;
...
export interface PlantillaContrato {
  ...
  nombre: string;
  descripcion: string;
  categoria: 'radio' | 'tv' | 'digital' | 'prensa' | 'omnicanal' | 'programatico' | 'marco';
...
export interface EventoAuditoria {
  ...
  recursoTipo: 'contrato' | 'clausula' | 'obligacion' | 'documento' | 'usuario' | 'configuracion';
  recursoId: string;
