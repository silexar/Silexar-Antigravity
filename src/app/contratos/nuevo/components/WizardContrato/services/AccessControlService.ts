...
const PERFILES_ROLES: PerfilRol[] = [
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    permisos: [
      { accion: 'crear_contrato', permitido: true, condiciones: ['valor <= $25M', 'requiere supervisión'], limites: { valorMaximo: 25000000 } },
      { accion: 'editar_contrato', permitido: true, condiciones: ['solo propios', 'no firmados'] },
      { accion: 'eliminar_contrato', permitido: false },
      { accion: 'ver_contrato', permitido: true, condiciones: ['solo asignados'] },
      { accion: 'aprobar_contrato', permitido: false },
      { accion: 'rechazar_contrato', permitido: false },
      { accion: 'aprobar_descuento', permitido: true, condiciones: ['máximo 10%'], limites: { descuentoMaximo: 10 } },
      { accion: 'configurar_terminos_pago', permitido: true, condiciones: ['máximo 30 días'], limites: { diasMaximo: 30 } },
      { accion: 'ver_metricas', permitido: true, condiciones: ['solo personales'] },
      ...
      { accion: 'exportar_datos', permitido: true, condiciones: ['solo propios'] },
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    permisos: [
      { accion: 'crear_contrato', permitido: true, condiciones: ['valor <= $100M'], limites: { valorMaximo: 100000000 } },
      { accion: 'editar_contrato', permitido: true, condiciones: ['de su cartera'] },
      { accion: 'eliminar_contrato', permitido: true, condiciones: ['solo borradores propios'] },
      { accion: 'ver_contrato', permitido: true, condiciones: ['cartera completa'] },
      { accion: 'aprobar_contrato', permitido: true, condiciones: ['de ejecutivos junior de su equipo'] },
      { accion: 'rechazar_contrato', permitido: true, condiciones: ['de ejecutivos junior'] },
      { accion: 'aprobar_descuento', permitido: true, condiciones: ['máximo 20%'], limites: { descuentoMaximo: 20 } },
      { accion: 'configurar_terminos_pago', permitido: true, condiciones: ['máximo 45 días'], limites: { diasMaximo: 45 } },
      { accion: 'ver_metricas', permitido: true, condiciones: ['personales y cartera'] },
      { accion: 'ver_pipeline', permitido: true, condiciones: ['solo su cartera'] },
      { accion: 'override_validaciones', permitido: false },
      { accion: 'configurar_politicas', permitido: false },
      { accion: 'gestionar_usuarios', permitido: false },
      { accion: 'acceso_auditoria', permitido: true, condiciones: ['solo lectura', 'su cartera'] },
      { accion: 'exportar_datos', permitido: true, condiciones: ['su cartera'] },
      { accion: 'firmar_contratos', permitido: true, condiciones: ['como representante comercial'] }
    ],
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    permisos: [
      { accion: 'crear_contrato', permitido: true, condiciones: ['valor <= $500M'], limites: { valorMaximo: 500000000 } },
      { accion: 'editar_contrato', permitido: true, condiciones: ['de su equipo'] },
      { accion: 'eliminar_contrato', permitido: true, condiciones: ['borradores de su equipo'] },
      { accion: 'ver_contrato', permitido: true, condiciones: ['contratos de su equipo'] },
      { accion: 'aprobar_contrato', permitido: true, condiciones: ['hasta $500M'], limites: { valorMaximo: 500000000 } },
      { accion: 'rechazar_contrato', permitido: true },
      { accion: 'aprobar_descuento', permitido: true, condiciones: ['máximo 30%'], limites: { descuentoMaximo: 30 } },
      { accion: 'configurar_terminos_pago', permitido: true, condiciones: ['máximo 60 días'], limites: { diasMaximo: 60 } },
      { accion: 'ver_metricas', permitido: true, condiciones: ['de su equipo'] },
      { accion: 'ver_pipeline', permitido: true, condiciones: ['de su equipo'] },
      { accion: 'override_validaciones', permitido: true, condiciones: ['solo validaciones menores'] },
      { accion: 'configurar_politicas', permitido: false },
      { accion: 'gestionar_usuarios', permitido: true, condiciones: ['solo su equipo'] },
      { accion: 'acceso_auditoria', permitido: true, condiciones: ['de su equipo'] },
      { accion: 'exportar_datos', permitido: true, condiciones: ['de su equipo'] },
      { accion: 'firmar_contratos', permitido: true, condiciones: ['como supervisor aprobador'] }
    ],
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    permisos: [
      ...
      { accion: 'ver_contrato', permitido: true, condiciones: ['acceso total pipeline'] },
      { accion: 'aprobar_contrato', permitido: true, condiciones: ['sin límite de valor'] },
      { accion: 'rechazar_contrato', permitido: true },
      { accion: 'aprobar_descuento', permitido: true, condiciones: ['hasta 50%'], limites: { descuentoMaximo: 50 } },
      { accion: 'configurar_terminos_pago', permitido: true, condiciones: ['hasta 90 días'], limites: { diasMaximo: 90 } },
      { accion: 'ver_metricas', permitido: true, condiciones: ['totales'] },
      { accion: 'ver_pipeline', permitido: true, condiciones: ['pipeline completo'] },
      { accion: 'override_validaciones', permitido: true, condiciones: ['todas las validaciones automáticas'] },
      { accion: 'configurar_politicas', permitido: true, condiciones: ['políticas de crédito'] },
      { accion: 'gestionar_usuarios', permitido: true, condiciones: ['todo el departamento'] },
      { accion: 'acceso_auditoria', permitido: true },
      { accion: 'exportar_datos', permitido: true },
      { accion: 'firmar_contratos', permitido: true, condiciones: ['como autoridad final'] }
    ],
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    descripcion: 'Responsable de facturación, validación de OC y emisión de facturas. Firma contratos para habilitar facturación.',
    nivel: 7,
    visibilidad: 'DEPARTAMENTO',
    limites: {
    ...
    permisos: [
      ...
      { accion: 'eliminar_contrato', permitido: false },
      { accion: 'ver_contrato', permitido: true, condiciones: ['contratos firmados para facturación'] },
      { accion: 'aprobar_contrato', permitido: false },
      { accion: 'rechazar_contrato', permitido: false },
      { accion: 'aprobar_descuento', permitido: true, condiciones: ['solo descuento pronto pago 5%'], limites: { descuentoMaximo: 5 } },
      { accion: 'configurar_terminos_pago', permitido: false },
      { accion: 'ver_metricas', permitido: true, condiciones: ['métricas de facturación'] },
      { accion: 'ver_pipeline', permitido: true, condiciones: ['contratos en facturación'] },
      { accion: 'override_validaciones', permitido: false },
      { accion: 'configurar_politicas', permitido: true, condiciones: ['políticas de facturación'] },
      { accion: 'gestionar_usuarios', permitido: true, condiciones: ['equipo de facturación'] },
      { accion: 'acceso_auditoria', permitido: true },
      { accion: 'exportar_datos', permitido: true },
      { accion: 'firmar_contratos', permitido: true, condiciones: ['firma para liberación a facturación'] },
      // Permisos específicos de facturación
      { accion: 'facturar_contrato', permitido: true },
      { accion: 'validar_oc', permitido: true, condiciones: ['validar OC contra contrato firmado'] },
      { accion: 'generar_factura', permitido: true },
      { accion: 'anular_factura', permitido: true, condiciones: ['con justificación y aprobación'] },
      { accion: 'liberar_factura', permitido: true, condiciones: ['después de validar OC y emisión'] },
      { accion: 'firmar_para_facturacion', permitido: true, condiciones: ['firma que habilita cobro'] },
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    descripcion: 'Responsable de gestión de cobranza, seguimiento de pagos, mora y acciones sobre clientes morosos.',
    nivel: 7,
    visibilidad: 'DEPARTAMENTO',
    limites: {
    ...
    permisos: [
      ...
      { accion: 'editar_contrato', permitido: false },
      { accion: 'eliminar_contrato', permitido: false },
      { accion: 'ver_contrato', permitido: true, condiciones: ['contratos con saldo pendiente'] },
      { accion: 'aprobar_contrato', permitido: false },
      { accion: 'rechazar_contrato', permitido: false },
      { accion: 'aprobar_descuento', permitido: true, condiciones: ['descuento por regularización 15%'], limites: { descuentoMaximo: 15 } },
      { accion: 'configurar_terminos_pago', permitido: true, condiciones: ['planes de pago para mora'] },
      { accion: 'ver_metricas', permitido: true, condiciones: ['métricas de cobranza'] },
      { accion: 'ver_pipeline', permitido: true, condiciones: ['pipeline de cobranza'] },
      { accion: 'override_validaciones', permitido: false },
      { accion: 'configurar_politicas', permitido: true, condiciones: ['políticas de cobranza y mora'] },
      { accion: 'gestionar_usuarios', permitido: true, condiciones: ['equipo de cobranza'] },
      { accion: 'acceso_auditoria', permitido: true },
      { accion: 'exportar_datos', permitido: true },
      { accion: 'firmar_contratos', permitido: false },
      ...
      { accion: 'aplicar_descuento_pago', permitido: true, condiciones: ['hasta 15%'], limites: { descuentoMaximo: 15 } },
      { accion: 'enviar_recordatorio_pago', permitido: true },
      { accion: 'bloquear_cliente', permitido: true, condiciones: ['por morosidad >60 días'] },
      { accion: 'gestionar_mora', permitido: true, condiciones: ['intereses, planes de pago'] }
    ],
    puedeEscalarA: ['GERENTE_GENERAL'],
    requiereAprobacionDe: ['GERENTE_GENERAL']
  },
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    permisos: [
      ...
      { accion: 'editar_contrato', permitido: false },
      { accion: 'eliminar_contrato', permitido: false },
      { accion: 'ver_contrato', permitido: true, condiciones: ['solo lectura para soporte'] },
      { accion: 'aprobar_contrato', permitido: false },
      { accion: 'rechazar_contrato', permitido: false },
      ...
      { accion: 'ver_metricas', permitido: true },
      { accion: 'ver_pipeline', permitido: true },
      { accion: 'override_validaciones', permitido: true, condiciones: ['solo técnicas'] },
      { accion: 'configurar_politicas', permitido: true },
      { accion: 'gestionar_usuarios', permitido: true },
      { accion: 'acceso_auditoria', permitido: true },
      { accion: 'exportar_datos', permitido: true },
...
class AccessControlServiceClass {
  ...
  private inicializarUsuariosPrueba(): void {
    const usuarios: Usuario[] = [
      { id: 'u-001', nombre: 'María López', email: 'mlopez@silexar.cl', rol: 'EJECUTIVO_JUNIOR', equipoId: 'eq-001', supervisorId: 'u-003', activo: true, fechaCreacion: new Date() },
      { id: 'u-002', nombre: 'Carlos Mendoza', email: 'cmendoza@silexar.cl', rol: 'EJECUTIVO_SENIOR', equipoId: 'eq-001', supervisorId: 'u-003', carteraClientes: ['cli-001', 'cli-002'], activo: true, fechaCreacion: new Date() },
      { id: 'u-003', nombre: 'Ana García', email: 'agarcia@silexar.cl', rol: 'SUPERVISOR', equipoId: 'eq-001', supervisorId: 'u-004', activo: true, fechaCreacion: new Date() },
      { id: 'u-004', nombre: 'Roberto Silva', email: 'rsilva@silexar.cl', rol: 'GERENTE_COMERCIAL', activo: true, fechaCreacion: new Date() },
      { id: 'u-005', nombre: 'Patricia Muñoz', email: 'pmunoz@silexar.cl', rol: 'GERENTE_GENERAL', activo: true, fechaCreacion: new Date() },
      // Nuevos roles de Facturación y Cobranza
      { id: 'u-006', nombre: 'Claudia Reyes', email: 'creyes@silexar.cl', rol: 'GERENTE_FACTURACION', activo: true, fechaCreacion: new Date() },
      { id: 'u-007', nombre: 'Fernando Vargas', email: 'fvargas@silexar.cl', rol: 'GERENTE_COBRANZA', activo: true, fechaCreacion: new Date() },
      { id: 'u-008', nombre: 'Sistema Admin', email: 'admin@silexar.cl', rol: 'ADMIN_SISTEMA', activo: true, fechaCreacion: new Date() }
    ];
  ...
  validarAccion(params: {
    ...
    if (!permiso || !permiso.permitido) {
      return {
        permitido: false,
        razon: `Acción "${params.accion}" no permitida para rol ${perfil.nombre}`,
    ...
    // Verificar límites
    const limitesExcedidos: { limite: string; valor: number; maximo: number }[] = [];

    // Límite de valor de contrato
    if (params.contexto.valorContrato && perfil.limites.valorMaximo < Infinity) {
    ...
    // Términos especiales
    if (params.contexto.terminosEspeciales && !perfil.limites.puedeAprobarTerminosEspeciales) {
      limitesExcedidos.push({
  ...
  private obtenerAprobadores(usuario: Usuario, _accion: PermisoAccion): Usuario[] {
  ...
  async procesarSolicitud(params: {
    ...
    if (solicitud.aprobadorId !== params.aprobadorId) throw new Error('No autorizado');
