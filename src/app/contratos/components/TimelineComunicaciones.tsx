...
const EVENTOS: Evento[] = [
  { id: 'e1', tipo: 'estado', titulo: 'Contrato enviado a aprobaci�n', descripcion: 'Nivel: Gerencia � Motivo: monto >$80M', autor: 'Sistema', fecha: '01 Mar', hora: '14:30' },
  { id: 'e2', tipo: 'email', titulo: 'Propuesta enviada al cliente', descripcion: 'PDF adjunto con tarifas Q2 2025 y condiciones especiales', autor: 'Mar�a Gonz�lez', fecha: '01 Mar', hora: '11:15' },
  { id: 'e3', tipo: 'llamada', titulo: 'Llamada con Gerente Comercial', descripcion: 'Duraci�n: 12 min. Acordaron descuento 15% y pago 45 d�as', autor: 'Mar�a Gonz�lez', fecha: '28 Feb', hora: '16:00' },
  { id: 'e4', tipo: 'nota', titulo: 'Nota: cliente prefiere radio AM', descripcion: 'Banco Chile hist�ricamente usa Radio Coraz�n en horario prime', autor: 'Carlos P�rez', fecha: '27 Feb', hora: '10:30' },
  { id: 'e5', tipo: 'documento', titulo: 'Cotizaci�n formal adjunta', descripcion: 'Cotizaci�n_BancoChile_Q2_2025.pdf � 1.8MB', autor: 'Mar�a Gonz�lez', fecha: '26 Feb', hora: '09:00' },
  { id: 'e6', tipo: 'email', titulo: 'Solicitud inicial del cliente', descripcion: 'Email de Jos� Rodr�guez solicitando campa�a radio 2 meses', autor: 'Cliente', fecha: '25 Feb', hora: '15:45' },
...
export function TimelineComunicaciones() {
  ...
  const tipoConfig: Record<string, { icon: React.ReactNode; color: string; bg: string }> = {
    email: { icon: <Mail className="w-4 h-4" />, color: 'text-[#6888ff]', bg: 'bg-[#6888ff]/10' },
    llamada: { icon: <Phone className="w-4 h-4" />, color: 'text-[#6888ff]', bg: 'bg-[#6888ff]/10' },
    nota: { icon: <Edit3 className="w-4 h-4" />, color: 'text-[#6888ff]', bg: 'bg-[#6888ff]/10' },
    estado: { icon: <CheckCircle2 className="w-4 h-4" />, color: 'text-[#6888ff]', bg: 'bg-[#dfeaff]' },
    documento: { icon: <Paperclip className="w-4 h-4" />, color: 'text-[#6888ff]', bg: 'bg-[#6888ff]/10' },
  };
