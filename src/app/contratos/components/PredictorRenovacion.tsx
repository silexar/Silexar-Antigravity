/**
 * ?? DESKTOP: IA Predictiva de Renovaci�n
 * 
 * Motor inteligente que analiza historial, predice probabilidad
 * de renovaci�n, y genera alertas 30/15/7 d�as antes.
 * Sugiere acciones y calcula riesgo de p�rdida.
 * 
...
const PREDICCIONES: Prediccion[] = [
  {
    ...
    factores: ['3 renovaciones consecutivas', 'Satisfacci�n alta', 'Presupuesto aprobado'],
    accionSugerida: { tipo: 'llamar', descripcion: 'Llamar para confirmar renovaci�n y ofrecer upgrade' },
  ...
  },
  {
    ...
    factores: ['Reestructuraci�n interna', 'Sin respuesta 5 d�as', 'Competencia activa'],
    accionSugerida: { tipo: 'reunion', descripcion: 'Agendar reuni�n urgente con director comercial' },
  ...
  },
  {
    ...
    accionSugerida: { tipo: 'descuento', descripcion: 'Ofrecer 3% descuento adicional por renovaci�n anticipada' },
  ...
  },
  {
    ...
    factores: ['Cliente fiel 4 a�os', 'Ya solicit� propuesta Q2', 'Incremento de inversi�n'],
  ...
  return (
    <div className="space-y-5">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h2 className="text-xl font-black text-[#69738c]">Predictor de Renovaci�n</h2>
          <p className="text-sm text-[#9aa3b8]">An�lisis IA de {PREDICCIONES.length} contratos pr�ximos a vencer</p>
        </div>
      </div>
                ...
                <div className="px-5 pb-4 space-y-3 border-t border-[#bec8de30] pt-3">
                  ...
                  <div className="p-3 rounded-xl bg-[#dfeaff] border border-[#bec8de30]">
                    <p className="text-[10px] font-bold text-[#6888ff] flex items-center gap-1">
                      <Sparkles className="w-3 h-3" /> Acci�n sugerida por IA
                    </p>
                  ...
                  <p className="text-[9px] text-[#9aa3b8] text-center">
                    <Calendar className="w-3 h-3 inline" /> Historial: {p.historialRenovaciones} renovaci�n{p.historialRenovaciones !== 1 ? 'es' : ''} previas
                  </p>
                </div>
              )}
            </div>
