...
const CLIENTES: ClienteSugerido[] = [
  ...
  { id: 'cli-007', nombre: 'LATAM', rubro: 'Aerol�nea', ultimoContrato: 'SP-2024-0088', valorAnterior: 200000000 },
...
export function ProposalGenerator() {
  ...
  const generarPropuesta = async () => {
    ...
    setPropuesta({
      ...
      objetivo: objetivo || `Campa�a multimedia Q2 para incrementar awareness y conversi�n`,
      medios: [
        { nombre: 'Radio Coraz�n', tipo: 'Radio FM', cantidad: 25, tarifa: 675000 },
      ...
      argumentosVenta: [
        ...
        `ROI estimado 3.2x basado en campa�as similares del sector ${cliente?.rubro}`,
      ...
      <div className="p-6">
            ...
            <div className="grid grid-cols-2 gap-3 max-h-64 overflow-y-auto">
              {clientesFiltrados.map(c => (
                <button key={c.id} onClick={() => { setClienteId(c.id); setStep('config'); }}
                  ...
                  {c.valorAnterior > 0 && (
                    <p className="text-[10px] text-[#6888ff] mt-1">�ltimo: ${(c.valorAnterior / 1e6).toFixed(0)}M</p>
                  )}
                </button>
              ))}
            </div>
        ...
        {step === 'config' && (
          <div className="space-y-4">
            ...
            <div>
              <label className="text-xs font-bold text-[#9aa3b8] block mb-1">Objetivo de la campa�a (opcional)</label>
              <textarea value={objetivo} onChange={e => setObjetivo(e.target.value)}
                placeholder="Ej: Incrementar ventas navide�as 20%... La IA completar� si lo dejas vac�o"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input value={presupuesto} onChange={e => setPresupuesto(e.target.value)}
                  placeholder="La IA sugerir� basado en historial"
          ...
          <div className="space-y-5">
            ...
            <div className="grid grid-cols-3 gap-3">
              ...
              <div className="bg-[#6888ff]/5 rounded-xl p-3 text-center">
                ...
                <p className="text-[9px] text-[#6888ff]">Duraci�n</p>
              </div>
            </div>
