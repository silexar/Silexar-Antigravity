...
const HOY: TareaChecklist[] = [
  ...
  { id: 't2', tipo: 'seguimiento', titulo: 'Llamar a Falabella', descripcion: 'Seguimiento propuesta #4521 enviada hace 3 d�as', prioridad: 'alta', completada: false, accion: 'Llamar' },
  { id: 't3', tipo: 'vencimientos', titulo: 'Contrato LATAM vence viernes', descripcion: 'SP-2024-0088 � $200M, coordinar renovaci�n', prioridad: 'alta', completada: false, accion: 'Renovar' },
  { id: 't4', tipo: 'propuesta', titulo: 'Enviar propuesta a Ripley', descripcion: 'Campa�a radio Q2, presupuesto $30M', prioridad: 'media', completada: false, accion: 'Crear' },
  { id: 't5', tipo: 'seguimiento', titulo: 'Confirmar pauta Cencosud', descripcion: 'Validar disponibilidad Radio Coraz�n 25 frases', prioridad: 'media', completada: true },
  { id: 't6', tipo: 'renovacion', titulo: 'Preparar renovaci�n Entel', descripcion: 'Vence en 30 d�as, revisar condiciones actuales', prioridad: 'baja', completada: false },
];
    ...
    <div className="neo-card rounded-2xl overflow-hidden">
      ...
      <div className="px-5 py-4 bg-[#dfeaff] border-b border-[#bec8de] flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-bold text-sm text-[#69738c]">Checklist del D�a</h3>
