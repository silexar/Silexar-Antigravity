...
const getAccionInfo = (tipo: TipoAccion) => {
  const info: Record<TipoAccion, { icon: React.ReactNode; color: string; label: string }> = {
    CREACION: { icon: <FileText className="w-4 h-4" />, color: 'bg-[#6888ff]/10 text-[#6888ff]', label: 'Creaci�n' },
    EDICION: { icon: <Edit className="w-4 h-4" />, color: 'bg-[#6888ff]/10 text-[#6888ff]', label: 'Edici�n' },
    APROBACION: { icon: <Check className="w-4 h-4" />, color: 'bg-[#6888ff]/10 text-[#6888ff]', label: 'Aprobaci�n' },
    ...
    VERSIONADO: { icon: <GitBranch className="w-4 h-4" />, color: 'bg-[#6888ff]/10 text-[#6888ff]', label: 'Versi�n' },
    ELIMINACION: { icon: <Trash2 className="w-4 h-4" />, color: 'bg-[#dfeaff] text-[#9aa3b8]', label: 'Eliminaci�n' },
    RESTAURACION: { icon: <RefreshCw className="w-4 h-4" />, color: 'bg-[#6888ff]/10 text-[#6888ff]', label: 'Restauraci�n' },
    CAMBIO_PERMISO: { icon: <Shield className="w-4 h-4" />, color: 'bg-[#6888ff]/10 text-[#6888ff]', label: 'Permiso' },
    ACCESO_AUDITORIA: { icon: <Shield className="w-4 h-4" />, color: 'bg-[#6888ff]/10 text-[#6888ff]', label: 'Auditor�a' }
  };
