...
const EVENTOS: Evento[] = [
  { id: 'e1', tipo: 'estado', titulo: 'Enviado a aprobaci�n', desc: 'Gerencia � monto >$80M', autor: 'Sistema', fecha: '01 Mar 14:30' },
  { id: 'e2', tipo: 'email', titulo: 'Propuesta enviada', desc: 'PDF tarifas Q2 2025', autor: 'Mar�a G.', fecha: '01 Mar 11:15' },
  { id: 'e3', tipo: 'llamada', titulo: 'Llamada Gte. Comercial', desc: '12 min � descuento 15%', autor: 'Mar�a G.', fecha: '28 Feb 16:00' },
  { id: 'e4', tipo: 'nota', titulo: 'Prefiere radio AM', desc: 'Radio Coraz�n horario prime', autor: 'Carlos P.', fecha: '27 Feb 10:30' },
  { id: 'e5', tipo: 'documento', titulo: 'Cotizaci�n adjunta', desc: 'Cotizaci�n_BancoChile.pdf', autor: 'Mar�a G.', fecha: '26 Feb 09:00' },
  { id: 'e6', tipo: 'email', titulo: 'Solicitud del cliente', desc: 'Campa�a radio 2 meses', autor: 'Cliente', fecha: '25 Feb 15:45' },
];
