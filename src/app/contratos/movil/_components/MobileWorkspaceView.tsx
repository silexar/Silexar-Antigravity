...
const TAREAS_MOCK: TareaWorkspace[] = [
  { id: 't-1', titulo: 'Enviar propuesta renovaci�n', contrato: 'CTR-0045', cliente: 'Falabella', prioridad: 'alta', tipo: 'tarea', vencimientos: '2025-02-28', completada: false },
  ...
  { id: 't-5', titulo: 'Preparar presentaci�n Q1', prioridad: 'baja', tipo: 'tarea', vencimientos: '2025-03-05', completada: false },
];
