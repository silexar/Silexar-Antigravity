/**
 * ?? MOBILE: IA Predictiva de Renovaci�n
 * 
 * Cards de predicci�n con probabilidad, tendencia,
...
const DATA: Pred[] = [
  { id: 'p1', cliente: 'Banco Chile', contrato: 'SP-2024-0142', valor: 85e6, dias: 15, prob: 92, tend: 'up', riesgo: 'bajo', factores: ['3 renovaciones', 'Satisfacci�n alta'], accion: 'Llamar para confirmar' },
  { id: 'p2', cliente: 'LATAM', contrato: 'SP-2024-0088', valor: 200e6, dias: 7, prob: 65, tend: 'down', riesgo: 'alto', factores: ['Sin respuesta 5 d�as', 'Competencia activa'], accion: 'Reuni�n urgente' },
  ...
  { id: 'p4', cliente: 'Cencosud', contrato: 'SP-2024-0201', valor: 45e6, dias: 20, prob: 88, tend: 'up', riesgo: 'bajo', factores: ['Cliente 4 a�os', 'Ya pidi� propuesta'], accion: 'Enviar propuesta Q2' },
];
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h3 className="font-bold text-lg text-[#69738c]">Predictor IA</h3>
          <p className="text-xs text-[#9aa3b8]">{DATA.length} contratos por vencer</p>
        </div>
      </div>
      ...
      <div className="space-y-2">
        {DATA.map(p => {
          ...
          return (
            <div key={p.id} className="bg-[#dfeaff] rounded-xl border border-[#bec8de30] overflow-hidden shadow-sm">
              ...
              {isExp && (
                <div className="px-3 pb-3 space-y-2 border-t border-[#bec8de30] pt-2">
                  ...
                  <div className="p-2 rounded-lg bg-[#dfeaff] border border-[#bec8de30]">
                    <p className="text-[10px] text-[#6888ff] flex items-center gap-1">
