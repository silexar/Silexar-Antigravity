    ...
    <div className="space-y-5">
      ...
      <div className="bg-[#6888ff] rounded-2xl p-5 text-white shadow-xl">
        <div className="flex items-center gap-2">
          ...
          <p className="text-xs font-bold text-[#9aa3b8] uppercase tracking-widest">Configuración</p>
        </div>
        <p className="text-sm text-[#9aa3b8] mt-2">Personaliza el comportamiento del módulo de contratos.</p>
      </div>

      {/* TOGGLES */}
      <div>
        <p className="text-xs font-bold text-[#9aa3b8] uppercase tracking-widest mb-3 px-1">Notificaciones y Automatración</p>
      ...
      {/* LINKS */}
      <div>
        <p className="text-xs font-bold text-[#9aa3b8] uppercase tracking-widest mb-3 px-1">Administración</p>
        <div className="space-y-2">
          {links.map(link => (
