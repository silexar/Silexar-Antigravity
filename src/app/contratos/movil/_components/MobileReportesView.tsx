...
const PLANTILLAS: ReportePlantilla[] = [
  { id: 'rpt-1', nombre: 'Resumen Ejecutivo', descripcion: 'KPIs principales y m�tricas clave', tipo: 'kpi', favorito: true, ultimoUso: '2025-02-26' },
  { id: 'rpt-2', nombre: 'Pipeline por Etapa', descripcion: 'Distribuci�n y valor por etapa', tipo: 'pipeline', favorito: true, ultimoUso: '2025-02-25' },
  { id: 'rpt-3', nombre: 'Tendencia Mensual', descripcion: 'Evoluci�n de contratos por mes', tipo: 'tendencia', favorito: false, ultimoUso: '2025-02-20' },
  { id: 'rpt-4', nombre: 'Comparativo YoY', descripcion: 'Comparaci�n a�o anterior', tipo: 'comparativo', favorito: false },
  { id: 'rpt-5', nombre: 'Top Clientes', descripcion: 'Ranking por valor de contrato', tipo: 'kpi', favorito: true, ultimoUso: '2025-02-24' },
  { id: 'rpt-6', nombre: 'An�lisis de Cobranza', descripcion: 'Estado de cuentas y aging', tipo: 'kpi', favorito: false },
];
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="bg-[#6888ff] rounded-2xl p-5 text-white shadow-xl">
        ...
        <p className="text-xs text-[#6888ff] mt-1">Genera reportes personalizados desde tu m�vil</p>
      </div>
