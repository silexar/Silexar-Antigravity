        ...
        <div className="px-5 pb-10">
          ...
          {success ? (
            ...
            <div className="space-y-4">
              {accionActiva === 'aprobar' && (
                <>
                  <div className="p-4 rounded-xl bg-[#6888ff]/5 border border-[#bec8de30] flex items-start gap-3">
                    ...
                    <p className="text-xs text-[#6888ff]">Al aprobar, este contrato avanzar� a la siguiente etapa del pipeline.</p>
                  </div>
                  <textarea
              ...
              {accionActiva === 'rechazar' && (
                <>
                  <div className="p-4 rounded-xl bg-[#dfeaff] border border-[#bec8de30] flex items-start gap-3">
                    ...
                    <p className="text-xs text-[#9aa3b8]">El contrato ser� devuelto al ejecutivo con el motivo de rechazo.</p>
                  </div>
                  <textarea
                    value={motivoText}
              ...
              {accionActiva === 'firmar' && (
                <div className="p-4 rounded-xl bg-[#6888ff]/5 border border-[#bec8de30] flex items-start gap-3">
                  ...
                  <p className="text-xs text-[#6888ff]">Se aplicar� tu firma digital certificada al contrato. Esta acci�n es irreversible.</p>
                </div>
              )}
            ...
            <div className="space-y-2">
              ...
              <ActionRow icon={<Mail className="w-5 h-5" />} label="Email" desc="Enviar comunicaci�n" color="bg-[#6888ff]/10 text-[#6888ff]" />
            </div>
          )}
        </div>
      </div>
