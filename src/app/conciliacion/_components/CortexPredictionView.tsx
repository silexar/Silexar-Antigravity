    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-500 pb-12">
      ...
      <div className="flex justify-between items-center bg-indigo-950/30 p-6 rounded-2xl border border-indigo-500/20 shadow-2xl relative overflow-hidden">
        ...
        <div className="flex items-center gap-6 relative z-10">
          ...
          <div>
            <h2 className="text-2xl font-black text-[#2C2C2A] uppercase tracking-tighter italic">✨ Cortex-Prediction IA</h2>
            <p className="text-xs text-indigo-400 font-black tracking-widest uppercase">Monitoreo Proactivo de Fallas (48h)</p>
          </div>
        </div>
        <div className="text-right relative z-10">
           <div className="text-[10px] font-black text-[#888780] uppercase tracking-widest mb-1">Estado de Inteligencia</div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
         ...
         <div className="space-y-4">
            <div className="bg-[#F0EDE8] p-8 rounded-3xl border border-white/5 shadow-2xl text-center">
               <div className="text-[10px] font-black text-[#888780] uppercase tracking-widest mb-4">Nivel de Riesgo Global</div>
               <div className="text-6xl font-black text-amber-500 mb-2">3.4</div>
               <div className="text-xs font-bold text-[#888780] uppercase">MODERADO</div>
               <div className="w-full h-2 bg-[#E8E5E0] rounded-full mt-6 overflow-hidden">
            ...
            <div className="bg-indigo-600/10 border border-indigo-500/30 rounded-3xl p-6 shadow-2xl space-y-4">
               ...
               <div className="flex justify-between items-end border-b border-indigo-500/20 pb-4">
                  <div>
                     <div className="text-3xl font-black text-[#2C2C2A]">92%</div>
                     <div className="text-[9px] text-[#888780] font-bold uppercase">Precisión Histórica</div>
                  </div>
               ...
               <p className="text-[10px] text-[#888780] leading-relaxed italic">"El motor ha analizado 2.4M de registros históricos de Dalet para identificar correlaciones entre hardware y errores de emisión."</p>
            </div>
         </div>
         ...
         <div className="lg:col-span-2 space-y-6">
            ...
            <div className="space-y-4">
               {predictions.map((p) => (
                  <div key={p.station} className="bg-[#F0EDE8]/50 border border-white/5 rounded-3xl p-6 flex flex-col md:flex-row gap-6 hover:bg-[#F0EDE8] transition-all border-l-4 border-l-indigo-500">
                     <div className="md:w-48 shrink-0">
                        <div className="text-lg font-black text-[#2C2C2A] uppercase">{p.station}</div>
                     ...
                     <div className="flex-1 space-y-3">
                        <div className="flex justify-between items-center mb-1">
                           ...
                           <div className="text-xl font-black text-[#2C2C2A]">{p.prob} <span className="text-[10px] text-[#888780] uppercase">Probabilidad</span></div>
                        </div>
                        <div className="bg-[#F0EDE8] p-4 rounded-2xl border border-white/5 flex items-center gap-4">
                           <div className="text-xl">✨</div>
                           <div>
                              <div className="text-[10px] font-black text-emerald-400 uppercase tracking-widest mb-1">Recomendación IA</div>
                              <p className="text-xs text-[#5F5E5A] font-medium">{p.recommendation}</p>
                           </div>
                        </div>
                     </div>
                     <div className="flex flex-col justify-center">
                        <button className="bg-indigo-600 hover:bg-indigo-500 text-[#2C2C2A] p-4 rounded-2xl transition-all shadow-lg active:scale-95">
                           APLICAR FIX
                        </button>
                     </div>
                  </div>
