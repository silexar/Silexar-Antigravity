    ...
    <div className="fixed inset-0 z-[60] bg-slate-900/60 backdrop-blur-sm flex items-center justify-center p-4">
      <div className="bg-slate-50 w-full max-w-3xl rounded-2xl shadow-2xl flex flex-col max-h-[90vh] overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="px-6 py-5 border-b border-indigo-100 bg-white flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500 font-medium mt-0.5">Clasificación Automática en Tiempo Real</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            ...
            <div className="bg-slate-50 border border-slate-100 p-4 rounded-lg flex items-start gap-4">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-1">
                  <span className="text-[10px] font-bold text-white bg-slate-800 px-2 py-0.5 rounded">NUEVA CAMPAÑA</span>
          ...
          <div className="grid grid-cols-2 gap-6">
               ...
               <div className="relative z-10 space-y-2">
                 {[
                   ...
                   <div key={i.k} className="flex items-center justify-between bg-white border border-slate-100 p-2.5 rounded-lg shadow-sm">
                     <span className="text-xs font-medium text-slate-500">{i.k}</span>
            ...
            <div className="col-span-1 space-y-6">
              <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm space-y-3">
                <h3 className="text-[11px] font-bold uppercase tracking-wider text-slate-400">📊 Factores de Decisión</h3>
              ...
              <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm space-y-3">
                <h3 className="text-[11px] font-bold uppercase tracking-wider text-slate-400">⚖️ Validaciones Automáticas</h3>
        ...
        <div className="px-6 py-4 border-t border-slate-100 bg-white flex items-center justify-between">
          <button className="px-5 py-2 text-slate-500 hover:bg-slate-50 font-medium border border-slate-200 rounded-lg text-sm transition-colors">
            Forzar Manual
          </button>
