        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          <div className="grid grid-cols-4 gap-4">
            <div className="bg-white border border-slate-200 p-4 rounded-xl shadow-sm flex flex-col justify-between">
              <div className="text-xs font-bold text-slate-400 uppercase tracking-wider mb-2">Coherencia Global</div>
            ...
            <div className="bg-white border border-slate-200 p-4 rounded-xl shadow-sm flex flex-col justify-between">
              <div className="text-xs font-bold text-slate-400 uppercase tracking-wider mb-2">Salud Base Datos</div>
              <div className="flex items-end gap-2">
                <span className="text-3xl font-black text-slate-800">100%</span>
                <span className="text-sm font-medium text-slate-500 mb-1">Índices OK</span>
              </div>
            </div>
          </div>
                ...
                <div className="bg-white border border-amber-200 rounded-xl overflow-hidden shadow-sm">
                  <div className="bg-amber-50 px-4 py-3 border-b border-amber-100 flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-500 font-medium">Valor "17 POLITICA" marcado como conflictivo cruzado.</p>
                    </div>
                  </div>
                  <div className="p-4 bg-white flex items-center justify-between">
                    <div className="space-y-1.5 flex-1">
                      <div className="text-sm flex items-center gap-2"><span className="text-slate-400 font-medium w-20">Impacto:</span> <span className="font-bold text-rose-600 bg-rose-50 px-2 py-0.5 rounded">3 contratos afectados</span></div>
                      <div className="text-sm flex items-center gap-2"><span className="text-slate-400 font-medium w-20">Sugerencia:</span> <span className="text-slate-700">Revisar reglas de validación exclusivas.</span></div>
                    </div>
                    <div className="flex flex-col gap-2 ml-4">
                      <button className="px-4 py-1.5 text-xs font-bold bg-amber-500 hover:bg-amber-600 text-white rounded-lg shadow-sm transition-colors flex items-center justify-center gap-1">Resolver</button>
                      <button className="px-4 py-1.5 text-xs font-bold text-slate-500 hover:bg-slate-50 border border-slate-200 rounded-lg transition-colors">Ignorar</button>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white border border-rose-200 rounded-xl overflow-hidden shadow-sm">
                  <div className="bg-rose-50 px-4 py-3 border-b border-rose-100 flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-500 font-medium">Cuenta <span className="font-mono bg-white px-1">6110045</span> no existe en el plan actual activo.</p>
                    </div>
                  </div>
                  <div className="p-4 bg-white flex items-center justify-between">
                    <div className="space-y-1.5 flex-1">
                      <div className="text-sm flex items-center gap-2"><span className="text-slate-400 font-medium w-20">Afectados:</span> <span className="font-bold text-rose-600 bg-rose-50 px-2 py-0.5 rounded">12 valores de propiedad</span></div>
                      <div className="text-sm flex items-center gap-2"><span className="text-slate-400 font-medium w-20">Sugerencia:</span> <span className="text-slate-700">Actualizar masivamente a cuenta <span className="font-mono text-emerald-600 font-bold bg-emerald-50 px-1 rounded">6110046</span></span></div>
                    </div>
                    <div className="flex flex-col gap-2 ml-4">
                      <button className="px-4 py-1.5 text-xs font-bold bg-rose-500 hover:bg-rose-600 text-white rounded-lg shadow-sm transition-colors flex items-center justify-center gap-1">Corregir Auto</button>
                      <button className="px-4 py-1.5 text-xs font-bold text-slate-500 hover:bg-slate-50 border border-slate-200 rounded-lg transition-colors">Edición Manual</button>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white border border-slate-200 rounded-xl overflow-hidden shadow-sm">
                  <div className="bg-slate-50 px-4 py-3 border-b border-slate-100 flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-500 font-medium">Valores "DIGITAL" y "AUDIO DIGITAL" son estructuralmente similares.</p>
                    </div>
                  </div>
                  <div className="p-4 bg-white flex items-center justify-between">
                    <div className="space-y-1.5 flex-1">
                      <div className="text-sm flex items-center gap-2"><span className="text-slate-400 font-medium w-20">Confusión:</span> <span className="font-bold text-amber-600 bg-amber-50 px-2 py-0.5 rounded">5 usuarios reportaron duda</span></div>
                      <div className="text-sm flex items-center gap-2"><span className="text-slate-400 font-medium w-20">Sugerencia:</span> <span className="text-slate-700">Consolidar bajo un mismo valor o renombrar para claridad.</span></div>
                    </div>
                    <div className="flex flex-col gap-2 ml-4">
                      <button className="px-4 py-1.5 text-xs font-bold bg-indigo-500 hover:bg-indigo-600 text-white rounded-lg shadow-sm transition-colors flex items-center justify-center gap-1">Consolidar</button>
                      <button className="px-4 py-1.5 text-xs font-bold text-slate-500 hover:bg-slate-50 border border-slate-200 rounded-lg transition-colors">Mantener</button>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-gradient-to-b from-indigo-50 to-white border border-indigo-100 rounded-xl p-4 shadow-sm relative overflow-hidden group">
                  ...
                  <div className="mt-4 flex gap-2 relative z-10">
                    <button className="flex-1 py-1.5 text-xs font-bold bg-indigo-600 text-white rounded-lg shadow-sm hover:bg-indigo-700 transition-colors">Crear</button>
                ...
                <div className="bg-gradient-to-b from-slate-50 to-white border border-slate-200 rounded-xl p-4 shadow-sm relative overflow-hidden group">
                  ...
                  <div className="mt-4 flex gap-2 relative z-10">
                    <button className="flex-1 py-1.5 text-xs font-bold bg-slate-800 text-white rounded-lg shadow-sm hover:bg-slate-700 transition-colors">Preview & Aplicar</button>
                  </div>
                </div>
