      ...
      <div className="bg-slate-50 w-full max-w-4xl rounded-2xl shadow-2xl flex flex-col max-h-[90vh] overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="px-6 py-5 border-b border-indigo-100 bg-white flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-[#888780] font-medium mt-0.5">Optimización Continua de Estructura de Datos</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            <span className="text-[10px] uppercase font-bold text-[#888780] flex items-center gap-1.5 mr-2">
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <span className="text-[10px] font-bold text-[#888780] uppercase tracking-wider">Próxima Revisión: 7 Días</span>
          </div>
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm flex flex-col">
              ...
              <div className="bg-slate-50 border border-slate-100 p-3 rounded-lg mb-4 flex-1">
                ...
                <div className="space-y-1.5">
                  <div className="text-xs flex justify-between"><span className="text-[#888780] font-medium">Beneficio:</span> <span className="text-emerald-600 font-bold bg-emerald-50 px-1.5 rounded">-15% Confusión, +12% Eficiencia</span></div>
                  <div className="text-xs flex justify-between"><span className="text-[#888780] font-medium">Riesgo IA:</span> <span className="text-emerald-600 font-bold bg-emerald-50 px-1.5 rounded">Muy Bajo (Migración 1-clic)</span></div>
                </div>
              </div>
              <div className="flex gap-2">
                <button className="flex-1 py-1.5 text-xs font-bold bg-indigo-600 text-[#2C2C2A] rounded-lg shadow-sm hover:bg-indigo-700 transition-colors">Ejecutar Migración</button>
            ...
            <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm flex flex-col">
              ...
              <div className="bg-slate-50 border border-slate-100 p-3 rounded-lg mb-4 flex-1">
                ...
                <div className="space-y-1.5">
                  <div className="text-xs flex justify-between"><span className="text-[#888780] font-medium">Justificación:</span> <span className="text-slate-700 font-bold text-right">67% usuarios filtran por duración <br/> manualmente en comentarios</span></div>
                  <div className="text-xs flex justify-between"><span className="text-[#888780] font-medium">ROI Estimado:</span> <span className="text-emerald-600 font-bold bg-emerald-50 px-1.5 rounded">+23% Eficiencia Prog.</span></div>
                </div>
              </div>
              <div className="flex gap-2">
                <button className="flex-1 py-1.5 text-xs font-bold bg-emerald-600 text-[#2C2C2A] rounded-lg shadow-sm hover:bg-emerald-700 transition-colors">Crear Propiedad</button>
            ...
            <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm flex flex-col">
              ...
              <div className="flex gap-2">
                <button className="flex-1 py-1.5 text-xs font-bold bg-rose-600 text-[#2C2C2A] rounded-lg shadow-sm hover:bg-rose-700 transition-colors">Eliminar</button>
            ...
            <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm flex flex-col">
              ...
              <div className="bg-slate-50 border border-slate-100 p-3 rounded-lg mb-4 flex-1">
                ...
                <div className="space-y-1.5">
                  <div className="text-xs flex justify-between"><span className="text-[#888780] font-medium">Beneficio:</span> <span className="text-emerald-600 font-bold bg-emerald-50 px-1.5 rounded">-8% Tiempo Selección</span></div>
                  <div className="text-xs flex justify-between"><span className="text-[#888780] font-medium">Impacto Dev:</span> <span className="text-indigo-600 font-bold bg-indigo-50 px-1.5 rounded">0 Cambios (Visual Only)</span></div>
                </div>
              </div>
              <div className="flex gap-2">
                <button className="flex-1 py-1.5 text-xs font-bold bg-amber-500 text-[#2C2C2A] rounded-lg shadow-sm hover:bg-amber-600 transition-colors">Aplicar Reorden</button>
        ...
        <div className="px-6 py-4 border-t border-slate-100 bg-white flex items-center justify-between">
          <div className="text-xs text-[#888780] font-medium">Recomendaciones generadas por IA estricta nivel 4</div>
          <div className="flex gap-2">
