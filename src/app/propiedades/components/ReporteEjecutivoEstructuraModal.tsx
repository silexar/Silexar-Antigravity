      ...
      <div className="bg-slate-50 w-full max-w-5xl rounded-2xl shadow-2xl flex flex-col max-h-[90vh] overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="px-6 py-5 border-b border-indigo-100 bg-white flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="p-2.5 bg-indigo-600 text-[#2C2C2A] rounded-xl shadow-md border border-indigo-700 relative overflow-hidden">
            ...
            <div>
              ...
              <p className="text-sm text-[#888780] font-medium mt-0.5">Salud Organizacional y Taxonomía - Q3 2026</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            ...
            <button className="px-3 py-2 text-sm font-bold text-[#2C2C2A] bg-indigo-600 border border-indigo-700 hover:bg-indigo-700 rounded-lg flex items-center gap-2 shadow-sm transition-colors">
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          <div className="grid grid-cols-4 gap-4">
            <div className="bg-white border border-slate-200 p-4 rounded-xl shadow-sm flex flex-col justify-between">
              <div className="text-xs font-bold text-[#888780] uppercase tracking-wider mb-2">Total Propiedades</div>
            ...
            <div className="bg-white border border-slate-200 p-4 rounded-xl shadow-sm flex flex-col justify-between relative overflow-hidden">
              <div className="text-xs font-bold text-[#888780] uppercase tracking-wider mb-2 relative z-10">Utilización Promedio</div>
            ...
            <div className="bg-white border border-slate-200 p-4 rounded-xl shadow-sm flex flex-col justify-between relative overflow-hidden">
              <div className="text-xs font-bold text-[#888780] uppercase tracking-wider mb-2 relative z-10">Coherencia Global</div>
              <div className="flex items-end gap-2 relative z-10">
            ...
            <div className="bg-gradient-to-br from-indigo-500 to-indigo-700 border border-indigo-600 p-4 rounded-xl shadow-md flex flex-col justify-between text-[#2C2C2A] relative overflow-hidden">
              ...
              <div className="flex items-end gap-2 relative z-10">
                <span className="text-3xl font-black text-[#2C2C2A]">8.9</span>
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div className="col-span-1 space-y-6">
              ...
              <div className="bg-[#E8E5E0] text-[#2C2C2A] rounded-xl p-5 shadow-sm space-y-4 relative overflow-hidden">
                ...
                <ul className="space-y-3 relative z-10">
                  <li className="flex gap-3 items-start">
                    ...
                    <span className="text-sm text-[#5F5E5A] font-medium">Expandir uso obligatorio de propiedades al módulo de <strong className="text-[#2C2C2A]">Facturación</strong>.</span>
                  </li>
                  <li className="flex gap-3 items-start">
                    ...
                    <span className="text-sm text-[#5F5E5A] font-medium">Integrar con <strong className="text-[#2C2C2A]">Sistema CRM Externo</strong> (Salesforce/Hubspot Sync).</span>
                  </li>
                  <li className="flex gap-3 items-start">
                    ...
                    <span className="text-sm text-[#5F5E5A] font-medium">Implementar el alcance de clasificación <strong className="text-[#2C2C2A]">predictiva en todos los módulos</strong> operativos.</span>
                  </li>
                  <li className="flex gap-3 items-start">
                    ...
                    <span className="text-sm text-[#5F5E5A] font-medium">Considerar arquitectura <strong className="text-[#2C2C2A]">multi-idioma</strong> para futura expansión LatAm.</span>
                  </li>
                </ul>
              </div>
