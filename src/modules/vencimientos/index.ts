...
export { VencimientoAuspicio } from './domain/entities/VencimientoAuspicio.js'
...
export type { IVencimientoRepository } from './domain/repositories/IVencimientoRepository.js'
