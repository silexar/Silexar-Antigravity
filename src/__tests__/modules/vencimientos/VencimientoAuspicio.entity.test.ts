...
import { VencimientosAuspicio } from '../../../modules/vencimientos/domain/entities/VencimientosAuspicio.js'
...
function makeProps(overrides: Partial<Parameters<typeof VencimientosAuspicio.create>[0]> = {}) {
  return {
...
describe('VencimientosAuspicio entity', () => {
  // ── create ─────────────────────────────────────────────────────────────────

  describe('create', () => {
    it('creates entity with generated id', () => {
      const v = VencimientosAuspicio.create(makeProps())
  ...
  describe('fromPersistence', () => {
    it('reconstitutes entity from stored data', () => {
      const now = new Date()
      const v = VencimientosAuspicio.fromPersistence({
        id: 'venc_persisted',
        cupoComercialId: 'cupo-1',
        programaId: 'prog-1',
        emisoraId: 'emisora-1',
